...
|   |   |
|:--|:--|
|`g:cpywrite#default_license`|The SPDX identifier of the license to be fetched by the `:CPYwrite` command. Default: `'GPL-3.0-or-later'`|
|`g:cpywrite#verbatim_mode`|When set to a non-zero value, the full license text will be requested -- only choose this when the license is no longer than 3-4 paragraphs (e.g. Unlicense, MIT, BSD 1- 2- 3-Clause, etc.). Default: `0`|
